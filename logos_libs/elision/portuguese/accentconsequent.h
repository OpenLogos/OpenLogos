...
*/
#ifndef __ElisionPortugueseAccentConsequent_h__
#define __ElisionPortugueseAccentConsequent_h__

//-------------------------------------------------------------------
// File - AccentConsequent.h
//
// Class - EL_PT_AccentConsequent
//
...
class EL_PT_AccentConsequent: public RE_Consequent<EL_Variable>
{
    DisableCopyAssign(EL_PT_AccentConsequent);

public:
    EL_PT_AccentConsequent(int group, int vowel, bool oneOnly);
...
inline EL_PT_AccentConsequent::EL_PT_AccentConsequent(int group, int vowel, bool oneOnly)
    : group_(group)
    , vowel_(vowel)
    , oneOnly_(oneOnly)
{
