...
*/
#ifndef __ElisionSpanishPrimitive_h__
#define __ElisionSpanishPrimitive_h__
...
//
// Description - a module for primitives used in spanish elision
//
//----------------------------------------------------------------------------

/* spanish documentation
------------------------------------------------------------------------------
  definition of a vowel in spanish
...
struct EL_SP_Primitive
{
    EL_SP_Primitive(LgsString& word);
...
private:
    ...
    static CharType GetCharType(LgsString::iterator& c);
...
inline EL_SP_Primitive::EL_SP_Primitive(LgsString& word)
    : word_(word)
{
}
