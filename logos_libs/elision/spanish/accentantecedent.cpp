...
bool EL_SP_AccentAntecedent::evaluate(EL_Variable& variable)
{
    assert(inrange(group_, 0, variable.groups()));

    EL_SP_Primitive primitive(variable.getSubString(group_));
    return !primitive.hasAccent();
}
