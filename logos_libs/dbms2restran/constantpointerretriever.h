...
*/
#ifndef _constantpointerretriever_h_
#define _constantpointerretriever_h_
...
{
public:
        CConstantPointerRetriever(SqlConnection*);
        ~CConstantPointerRetriever();
...
private:
        ...
        SqlColumn*              m_pPrimaryUsageIdColumn;
        SqlColumn*              m_pAlternateUsageIdColumn;
};
