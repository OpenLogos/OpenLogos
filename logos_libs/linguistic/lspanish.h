...
*/
#ifndef __lspanish_h__
#define __lspanish_h__
...
class LSpanish: public LLanguage
{
   DisableCopyAssign(LSpanish);

public:
   static LSpanish* create(const LgsString& languageCode);
