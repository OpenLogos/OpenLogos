...
*/
#ifndef __companybuilder_h__
#define __companybuilder_h__

#include <logos_libs/entity/dcompany.h>

//-------------------------------------------------------------------
// File - companybuilder.h
//
// Class - CompanyBuilder (Abstract)
//
...
public:
    ...
    //-----------------------------------------------------------------
        ...
        virtual DCompany* Build( const LgsString& companyCode,
                             LinguisticFactory& ) const = 0;
		virtual DCompanyVector * Build(LinguisticFactory& factory) const = 0;

};

#endif // __companybuilder_h__
