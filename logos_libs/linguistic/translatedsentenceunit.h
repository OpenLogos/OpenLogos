...
*/
#ifndef __translatedsentenceunit_h__
#define __translatedsentenceunit_h__

//-------------------------------------------------------------------
// File - translatedsentenceunit.h
//
...
class TranslatedSentenceUnit: public TargetDictionaryUnit
{
public:
   TranslatedSentenceUnit();
   TranslatedSentenceUnit(LDictionary&);
   TranslatedSentenceUnit(const TranslatedSentenceUnit&);
   virtual ~TranslatedSentenceUnit();
...
#endif // __TranslatedSentenceUnit_h__
