...
//---------------------------------------------------------------------
CLgsOut &CLgsOut::singleton()
{
   return m_logStream;
}
//---------------------------------------------------------------------
void CLgsOut::setLogFile(const LgsString &fileName) 
{
   m_fileName = fileName;
   if( !fileName.empty() )
   {
      pLogFile = new ofstream(fileName.c_str(), ios_base::out /*| ios_base::app*/);
   }
}
//---------------------------------------------------------------------
bool CLgsOut::AppendFile(const LgsString &fileName)
{
   bool res = false;
...
//---------------------------------------------------------------------
CLgsOut &CLgsOut::operator<<(LgsString &s) 
{
   cout << s;
   if( pLogFile )
   {
...
//---------------------------------------------------------------------
CLgsOut &CLgsOut::operator<<(const LgsString &s) 
{
   cout << s;
   if( pLogFile )
   {
