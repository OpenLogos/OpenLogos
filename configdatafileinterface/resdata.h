...
*/
// ResData.h: interface for the CResData class.
//
//////////////////////////////////////////////////////////////////////
...
class CResData : public CSourceData
{
public:
   virtual bool GetData(LgsString& key, LgsString& DataBuf);
   CResData(const LgsString& srcLang, const LgsString& trgLang, bool isTwoPass,
...
private:
   LgsString res1MainFileName;
   LgsString res2MainFileName;
   LgsString res22MainFileName;
   LgsString res2MiniFileName;
};
