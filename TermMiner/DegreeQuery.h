...
*/
// DegreeQuery.h: interface for the DegreeQuery class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DegreeQuery_h_
#define _DegreeQuery_h_
...
// --------------------------------------------------------------------------
// Definition of class DegreeQuery to query the database
// for Degree from the table word_class_subtype
// --------------------------------------------------------------------------
class DegreeQuery: public SqlQuery 
{
public:
	DegreeQuery();
   virtual ~DegreeQuery();
